...
- The individual components of the score are listed in `other_results/SQM2.20_score_components.txt`
- PM6-D3H4/COSMO interactrion energies are provided in `other_results/dG_int_PM6-D3H4X_COSMO.txt`
